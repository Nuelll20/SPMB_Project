...
<head>
    ...
    <style>
        ...
        .bg-sakti-blue { background-color: #002B5B; }
        .text-sakti-blue { color: #002B5B; }
        .border-sakti-blue { border-color: #002B5B; }
        .bg-sakti-light { background-color: #E8F0FE; }
        .text-sakti-orange { color: #E5A93C; }
...
<body class="bg-[#F4F7FA] font-sans antialiased text-gray-700 min-h-screen pb-12">
    ...
    <div class="max-w-6xl mx-auto px-4 mt-6">
       <header class="bg-white rounded-3xl p-4 shadow-sm flex flex-col md:flex-row justify-between items-center border border-gray-100 mb-8">
            ...
            <nav class="flex items-center space-x-8 my-4 md:my-0 font-semibold text-sm">
                <a href="#" class="text-sakti-blue flex items-center space-x-2 relative py-1">
                    ...
                    <span>Dashboard</span>
                    <span class="absolute bottom-0 left-1/2 -translate-x-1/2 w-1.5 h-1.5 bg-sakti-orange rounded-full"></span>
                </a>
            ...
            <div class="flex items-center space-x-4">
                ...
                <button class="bg-[#FFF0F0] text-[#FF4D4D] p-3 rounded-2xl hover:bg-[#FFE0E0] transition flex items-center justify-center">
                    <i class="fa-solid fa-arrow-right-from-bracket text-md"></i>
                </button>
            </div>
        </header>

        <main class="bg-white rounded-[40px] shadow-sm border border-gray-50 px-6 py-12 md:px-20 text-center max-w-4xl mx-auto">
            ...
            <form action="{{ route('profil.ortu.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <select name="pendidikan" class="w-full bg-white border border-gray-200 rounded-2xl px-4 py-3.5 text-sm font-semibold text-sakti-blue focus:outline-none focus:border-sakti-blue appearance-none cursor-pointer shadow-sm">
                    ...
                    <div class="space-y-2">
                        <label class="text-[11px] font-bold text-gray-400 uppercase tracking-wider block">Rentang Penghasilan</label>
                        <div class="relative">
                            <select name="penghasilan" class="w-full bg-white border border-gray-200 rounded-2xl px-4 py-3.5 text-sm font-semibold text-sakti-blue focus:outline-none focus:border-sakti-blue appearance-none cursor-pointer shadow-sm">
...
>>>>>>> 7eb49654f98222510327f95abf3ba09f0176b191
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        <label class="text-[11px] font-bold text-gray-400 uppercase tracking-wider block">Wilayah Pendaftaran</label>
                        <div class="relative">
                            <select name="wilayah" class="w-full bg-white border border-gray-200 rounded-2xl px-4 py-3.5 text-sm font-semibold text-sakti-blue focus:outline-none focus:border-sakti-blue appearance-none cursor-pointer shadow-sm">
                    ...
                    <div class="space-y-2">
                        <label class="text-[11px] font-bold text-gray-400 uppercase tracking-wider block">Unit Sekolah Tujuan</label>
                        <div class="relative">
                ...
                <div class="space-y-4 pt-4 text-center">
                    <label class="text-[11px] font-bold text-gray-400 uppercase tracking-wider block">Jumlah Anak Yang Akan Didaftarkan</label>
